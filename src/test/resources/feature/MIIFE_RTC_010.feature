...
And I clear existing "<Name>" for "<username>"
...
|AuxTestUser005|1qaz2wsx@|AuxAppTest |AuxTestUser005|https://identity.qa.example.com/playground2/oauth2.jsp?reset=true|AuXTestAPI003|Default|INACTIVE|No subscriptions are created yet. To add a new subscription , select an API and subscribe to it from API listing page .|AuxTestUser005_AuXTestAPI003|