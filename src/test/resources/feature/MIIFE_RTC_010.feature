...
|APPCREATE|AuxTestAPI-1.0.0.1 |AuXTestAPI003|https://identity.qa.example.com/playground2/oauth2.jsp?reset=true|AuXTestAPI003|Default|INACTIVE|No subscriptions are created yet. To add a new subscription , select an API and subscribe to it from API listing page .|AuxTestUser002_AuXTestAPI003|