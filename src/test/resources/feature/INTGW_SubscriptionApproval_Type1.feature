...
Examples:
|usertypeAdmin|usertype |apiPublisherOne|appName     |action |options        |subscribeAPI   |
|AdminUser    |PUBLISHER|apipublisherOne|AuXTestAPPA |Approve|Approve,Reject |WeatherAPI - v1|
...
And I should see Action "<options>" of the "<appName>" task in the dropdown
Examples:
|usertypeAdmin|usertype |apiPublisherOne|appName     |action |options        |subscribeAPI   |tiers    |
|AdminUser    |PUBLISHER|apipublisherOne|AuXTestAPPC |Approve|Approve,Reject |WeatherAPI - v1|Unlimited|
...
|APPCREATE |PUBLISHER|apipublisherOne|AuXTestAPPA |Approve|WeatherAPI - v1|Large|ACTIVE|
...
When I click on apimanager My Applications
Then I should see the apimanager Application page header as "Applications"
Then I should see the Application "<appName>" workflow status as "<status>" and Tier as "<tiers>"
Examples:
|usertypeSP|usertype |apiPublisherOne|appName     |action |subscribeAPI   |tiers|status|
|APPCREATE |PUBLISHER|apipublisherOne|AuXTestAPPC |Approve|WeatherAPI - v1|Large|ACTIVE|
...
Then I should see the Application "<appName>" workflow status as "<status>" and Tier as "<tiers>"
Examples:
|usertypeAdmin|usertypeSP|usertype |apiPublisherOne|appName     |action |subscribeAPI   |tiers|status|
|AdminUser    |APPCREATE |PUBLISHER|apipublisherOne|AuXTestAPPD |Approve|WeatherAPI - v1|Large|ACTIVE|
...
Examples:
|usertypeAdmin|usertypeSP|usertype |apiPublisherOne|appName     |action |subscribeAPI   |olderTier|newTier  |status|
|AdminUser    |APPCREATE |PUBLISHER|apipublisherOne|AuXTestAPPE |Approve|WeatherAPI - v1|Large    |Unlimited|ACTIVE|
...
And I click on Start button for "<appName>" Application Details row for "<usertypeAdmin>"
Then I should see the status of the application "<appName>" approval task as "IN_PROGRESS" 
And I select "<actionAdmin>" and click complete button for "<appName>" Application Details row for "<usertypeAdmin>"
Then I should see Enter aprrove/reject reasons pop up header as "Enter approve/reject reasons"
When I enter aprrove/reject reason as "Approve"
And click aprrove/reject reason ok button
Then I should not see created subscription with "<appName>" and "<subscribeAPI>" in the Approval Tasks table
...
And I click on Start button for "<appName>" Application Details row for "<usertype>"
Then I should see the status of the application "<appName>" approval task as "IN_PROGRESS"
And I select "<actionPub>" and click complete button for "<appName>" Application Details row for "<usertype>"
Then I should see Enter aprrove/reject reasons pop up header as "Enter approve/reject reasons"
...
Examples:
|usertypeAdmin|usertypeSP|usertype |apiPublisherOne|appName     |actionAdmin|actionPub |subscribeAPI   |tier   |status  |
|AdminUser    |APPCREATE |PUBLISHER|apipublisherOne|AuXTestAPPB |Approve    |Reject    |WeatherAPI - v1|Default|REJECTED|
...
|AdminUser    |APPCREATE |PUBLISHER|apipublisherOne|AuXTestAPPB |Approve    |WeatherAPI - v1|Default|ON_HOLD |WeatherAPI|v1     |
...
And I select "<tier>" for "<appName>" Application Details row for "<usertypeAdmin>"
And I click on Start button for "<appName>" Application Details row for "<usertypeAdmin>"
Then I should see the status of the application "<appName>" approval task as "IN_PROGRESS" 
And I select "<action>" and click complete button for "<appName>" Application Details row for "<usertypeAdmin>"
Then I should see Enter aprrove/reject reasons pop up header as "Enter approve/reject reasons"
...
Examples:
|usertypeAdmin|usertypeSP|usertype |apiPublisherOne|appName     |action |subscribeAPI   |tier |status|
|AdminUser    |APPCREATE |PUBLISHER|apipublisherOne|AuXTestAPPA |Approve|WeatherAPI - v1|Large|ACTIVE|
