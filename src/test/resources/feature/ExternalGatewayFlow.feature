...
Examples:
|usertypePub|usertypeSP|usertypeAdmin|apiName   |version|context        |prodEndpoint |roleType		      |ApiTier                                                               |LastName   |FirstName   |Email	           |appName         |Description  |AppStatusBeforeApprove|action |AppStatusAfterApprove|AppTier  |Subscriptiontiers|subscriptionStatus|
|PUBLISHER  |APPCREATE |AdminUser    |AuxProdAPI|v1     |APIProdCreation|auxProd	  |Internal/publisher |Unlimited,Default,Requestbased,Silver,Subscription,Gold,Premium,Bronze|AuxTestLast|AuxTestFirst|AuxTest123@gmail.com|AuXTestAPPM  	|AuXTestingAPP|INACTIVE              |Approve|ACTIVE               |Unlimited|Premium          |UNBLOCKED         |
