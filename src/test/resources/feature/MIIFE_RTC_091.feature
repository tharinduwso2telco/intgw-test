Feature: Validate if tokens generated before subscription approval task was completed

  @Smoke
  Scenario Outline: Check if tokens generated before subscription approval was completed works
    ...
    Examples:
      ...
      | LOGOUT   | Unlimited          | Approve | READY  | AuxAppTest | DIALOG   | -1       | https://identity.qa.example.com/playground2/oauth2.jsp?reset=true | AuXTestAPI  | AuxTestingAppRTC_091 |