...
|LOGOUT   |AuxAppTest|94123496789     |APIwise Whitelist   |AuxLogoutUserApp|Whitelist Numbers Successfully Added to the system  |Whitelist Numbers could not be added to the system |