...
Then I should not see the created application in Approval Tasks table as "<appName>" for "<usertype>"
When I click on close window
Then  I click on apimanager My Subscriptions
...
And I should be able to invoke the API

Examples:
| usertype   |appName                  |Action |apiName                       |operator|CallbackURL|Description||validity|
|SUBSCRIPTION|AuxSubscriptionTestingApp|Approve|AuxAppTest                    |DIALOG  |https://identity.qa.example.com/playground2/oauth2.jsp?reset=true|AuxSubTestAPI||1       |
