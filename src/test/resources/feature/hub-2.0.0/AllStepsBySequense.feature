...
#API Publisher Create and Publish an APIs
  ...
  Scenario Outline: HUB API Create flow
    ...
    Examples:
      ...
      |PUBLISHER  |payment      |v1     |payment     |http://localhost:8280/payment/v1|http://localhost:8181/payment/v1|Unlimited,Default,Requestbased,Silver,Subscription,Gold,Premium,Bronze|
      |PUBLISHER  |ussd         |v1     |ussd        |http://localhost:8280/ussd/v1     |http://localhost:8181/ussd/v1|Unlimited,Default,Requestbased,Silver,Subscription,Gold,Premium,Bronze|
      |PUBLISHER  |location     |v1     |location     |http://localhost:8280/location/v1|http://localhost:8181/location/v1|Unlimited,Default,Requestbased,Silver,Subscription,Gold,Premium,Bronze|
      |PUBLISHER  |smsmessaging |v1     |smsmessaging|http://localhost:8280/smsmessaging/v1|http://localhost:8181/smsmessaging/v1|Unlimited,Default,Requestbased,Silver,Subscription,Gold,Premium,Bronze|
      |PUBLISHER  |credit       |v1     |credit      |http://localhost:8280/credit/v1|http://localhost:8181/credit/v1|Unlimited,Default,Requestbased,Silver,Subscription,Gold,Premium,Bronze|
      |PUBLISHER  |wallet       |v1     |wallet      |http://localhost:8280/wallet/v1|http://localhost:8181/wallet/v1|Unlimited,Default,Requestbased,Silver,Subscription,Gold,Premium,Bronze|
      |PUBLISHER  |provisioning |v1     |provisioning|http://localhost:8280/provisioning/v1|http://localhost:8181/provisioning/v1|Unlimited,Default,Requestbased,Silver,Subscription,Gold,Premium,Bronze|
      |PUBLISHER  |customerinfo |v1     |customerinfo|http://localhost:8280/customerinfo/v1|http://localhost:8181/customerinfo/v1|Unlimited,Default,Requestbased,Silver,Subscription,Gold,Premium,Bronze|
