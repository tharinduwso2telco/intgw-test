...
Then I should see ids Main menu
...
Then I should see ids Service providers page
...
Then I should see OAth client key and OAth client secret
...
Then I should see View/Update application settings page
...
Then I should see Application updated successfully pop up
